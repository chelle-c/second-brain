...
import { Inbox, ChevronRight, ChevronDown, Folder } from "lucide-react";
...
export const FolderNav = ({
	...
	return (
		<div className="bg-white flex flex-col items-start justify-start px-4 py-4 rounded-lg shadow-md lg:w-min">
			<h3 className="w-full font-semibold mb-3 text-gray-700">Folders</h3>
						...
						<div key={key}>
							...
							>
								...
								<div
									...
									className="flex-1 flex items-center justify-between gap-16 px-3 py-2 cursor-pointer"
								>
									<div className="flex items-center gap-2">
										<Icon size={18} />

						...
						<div className="space-y-0.5">
							...
							<p className="text-sm text-muted-foreground">
								{currentEnvironment === "production"
									? "Using production database with your real data"
						...
						<>
							<div className="p-3 bg-amber-500/10 border border-amber-500/20 rounded-lg">
								<p className="text-sm text-amber-600 dark:text-amber-400 flex items-center gap-2">
									...
									You are running in development mode. Changes won't affect your production data.
								</p>
							</div>
						...
						<>
							<div className="flex items-center justify-between">
								...
								<Select
									...
									onValueChange={(value) => setAutoBackupInterval(parseInt(value))}
								>
					...
					<div className="space-y-4">
						...
						<div className="flex gap-2">
							<Input
								...
								className="flex-1"
							/>
							<Button onClick={handleSetCustomPath} variant="outline" disabled={!customPathInput.trim()}>
								Apply
							</Button>
						</div>

						<div className="flex gap-2">
							<Button onClick={handleUseDocumentsFolder} variant="secondary" size="sm">
			...
			<Dialog open={showCreateBackup} onOpenChange={setShowCreateBackup}>
				<DialogContent>
					<DialogHeader>
						...
						<DialogDescription>
							Create a new backup of your current data. You can add an optional description.
						</DialogDescription>
					</DialogHeader>
					<div className="py-4">
									...
									>
										<div className="space-y-1">
											...
											<div className="text-sm text-muted-foreground">
												{formatDate(backup.metadata.createdAt)} • v{backup.metadata.version}
												{backup.metadata.fileSize && ` • ${formatFileSize(backup.metadata.fileSize)}`}
											</div>
										</div>
										<div className="flex gap-2">
											<Button
			...
			<AlertDialog open={showSeedConfirm} onOpenChange={setShowSeedConfirm}>
				<AlertDialogContent>
					<AlertDialogHeader>
						...
						<AlertDialogDescription>
							This will clear all existing data in the test database and replace it with sample data including:

...
import type { Expense, ExpenseFormData, OverviewMode } from "@/types/expense";
	...
	subscribeWithSelector((set, get) => ({
		...
		redo: () => {
			...
			switch (type) {
				case "CREATE_EXPENSE":
					if (data.after) {
						const afterExpense = data.after as Expense;
						set((state) => {

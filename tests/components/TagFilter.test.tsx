...
import { TagFilter } from '../../src/apps/Notes/components/TagFilter';
import type { Tag } from '../../src/types/notes';
...
describe('TagFilter', () => {
  ...
  it('should render filter label', () => {
    render(
      <TagFilter tags={mockTags} activeTags={[]} setActiveTags={mockSetActiveTags} />
    );

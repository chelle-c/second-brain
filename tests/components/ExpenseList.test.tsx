...
import { ExpenseList } from '../../src/apps/Finances/expenses/components/ExpenseList';
...
vi.mock('../../src/apps/Finances/expenses/components/ExpenseTable', () => ({
...
vi.mock('../../src/apps/Finances/expenses/components/DeleteModal', () => ({
...
describe('ExpenseList', () => {
  ...
  it('should show empty state when no expenses match the filter', () => {
    ...
    expect(screen.getByText(/Click the \+ button to add your first expense/i)).toBeInTheDocument();
  });
